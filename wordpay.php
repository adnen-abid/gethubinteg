...
<body>
<!-- This is an order details submission form, for more information on the elements within a form please refer to the section Order Details Form Structure. -->
...
<input type="hidden" name="MC_callback" value="http://egyptspiritholidays.co.uk/">
<input type="hidden" name="instId" value="299803">
...
if (productNo==1)
{
document.BuyForm.amount.value = 1.00;
